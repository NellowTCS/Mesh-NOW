...
function createPanel() {
    ...
    panel.style.cssText =
        'position:fixed;right:8px;bottom:8px;width:360px;height:220px;z-index:99999;font-family:monospace;font-size:12px;';

    const header = document.createElement('div');
    header.style.cssText =
        'background:#222;color:#fff;padding:6px;border-radius:6px 6px 0 0;display:flex;justify-content:space-between;align-items:center;';
    ...
    listEl.style.cssText =
        'background:#111;color:#eee;height:170px;overflow:auto;padding:6px;border-radius:0 0 6px 6px;';
...
export function initDevTools() {
    ...
    if (!toggleButton) {
        ...
        toggleButton.style.cssText =
            'position:fixed;right:12px;bottom:240px;z-index:99999;background:#111;color:#fff;border-radius:6px;padding:8px;border:1px solid rgba(255,255,255,0.06);cursor:pointer;font-size:16px;';
